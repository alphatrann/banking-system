...
-- CreateIndex
CREATE UNIQUE INDEX "outbox_events_aggregate_type_aggregate_id_key" ON "outbox_events"("aggregate_type", "aggregate_id");
-- CreateIndex
...
ADD CONSTRAINT "email_events_to_account_id_fkey" FOREIGN KEY ("to_account_id") REFERENCES "accounts"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
-- AddForeignKey
